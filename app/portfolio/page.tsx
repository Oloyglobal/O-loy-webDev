...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: 'E-commerce',
      client: 'Slicq Stitches',
      description: 'A modern fashion e-commerce platform showcasing premium tailoring, custom fits, and ready-to-wear collections with seamless shopping experience.',
      tags: ['Next.js', 'React'],
      image: '/projects/Stitches_-_Polo_Park.webp',
      link: 'https://www.slicq.com/',
    ...
    },
    {
      ...
      tags: ['Next.js', 'React'],
      image: '/projects/work_thumb_2.jpg.webp',
